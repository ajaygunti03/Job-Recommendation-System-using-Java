...
<div class="wrapper row1">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="company.jsp"><strong>COMPANY</strong></a></li>
  ...
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear">
        <center>
           ...
           <form action="CompanyRegAction.jsp" method="post">
          <table>
              <tr><th>Company Name</th><td><input type="text" name="cname" required=""></tD></tr>
              <tr><th>Company Email</th><td><input type="email" name="email" required=""></tD></tr>
                <tr><th>Company Mobile</th><td><input type="number" name="mobile" required=""></tD></tr>
